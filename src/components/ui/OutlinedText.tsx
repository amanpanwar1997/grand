...
export const OutlinedText = ({
  ...
  // 🎯 CENTRALIZED SIZE CLASSES - From design tokens
  // ⚠️ TO CHANGE ALL BACKGROUND TEXT SIZES GLOBALLY:
  // Edit: /utils/designTokens.tsx → typography.outlinedText → mobile/tablet/desktop
  const sizeClasses = {
