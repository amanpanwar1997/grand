  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'Local SEO', slug: 'seo/local-seo', icon: TrendingUp, isSubService: true },
        { name: 'Technical SEO', slug: 'seo/technical-seo', icon: TrendingUp, isSubService: true },
      ]
    },
    {
      ...
      services: [
        ...
        { name: 'Google Shopping Ads', slug: 'ppc/google-shopping', icon: ShoppingCart, isSubService: true },
        { name: 'Display Advertising', slug: 'ppc/display-ads', icon: LayoutGrid, isSubService: true },
      ]
    },
    {
      name: 'Social Media',
      services: [
        ...
        { name: 'Instagram Marketing', slug: 'social-media/instagram', icon: Smartphone, isSubService: true },
        { name: 'Facebook Marketing', slug: 'social-media/facebook', icon: Smartphone, isSubService: true },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Professional Copywriting', slug: 'content/copywriting', icon: FileText, isSubService: true },
        { name: 'Blog Writing Services', slug: 'content/blog-writing', icon: BookOpen, isSubService: true },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'eCommerce Development', slug: 'web-design/ecommerce', icon: ShoppingCart, isSubService: true },
        { name: 'WordPress Development', slug: 'web-design/wordpress', icon: Code, isSubService: true },
      ]
    },
    {
      name: 'More Services',
