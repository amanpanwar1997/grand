    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-6">
          <h2 className="text-[22px] font-bold mb-8 text-center">Why Work With Us</h2>
      ...
      <section id="openings" className="py-16 md:py-24 bg-white/[0.02]">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-[22px] font-bold mb-8 text-center">Current Openings</h2>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-[22px] font-bold mb-6">Don't See Your Role?</h2>
            <p className="text-[15px] text-gray-400 mb-8">
