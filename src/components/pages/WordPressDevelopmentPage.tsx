...
export function WordPressDevelopmentPage() {
  const breadcrumbItems = [
    ...
    { name: 'Web Design', path: '/services/web-design-development' }, { name: 'WordPress', path: '/services/web-design/wordpress' }
  ];
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-16 md:py-24 border-t border-white/5">
        <div className="container mx-auto px-6 text-center">
          ...
          <h2 className="text-[22px] font-bold mb-4">Power Your Website with WordPress</h2>
