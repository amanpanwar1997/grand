  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-16 md:py-24 border-b border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-[22px] md:text-[28px] font-bold mb-4">Complete Influencer Marketing Services</h2>
      ...
      <section className="py-16 md:py-24 border-b border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-[22px] md:text-[28px] font-bold mb-4">Choose the Right Influencer Tier</h2>
            <p className="text-[15px] text-gray-400">
      ...
      <section className="py-16 md:py-24 border-b border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-[22px] md:text-[28px] font-bold mb-4">Our Influencer Campaign Process</h2>
            <p className="text-[15px] text-gray-400">
      ...
      <section className="py-16 md:py-24 border-b border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-[22px] md:text-[28px] font-bold mb-4">Multi-Platform Influencer Network</h2>
            <p className="text-[15px] text-gray-400">
      ...
      <section className="py-16 md:py-24 border-b border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-[22px] md:text-[28px] font-bold mb-4">What's Included</h2>
            <p className="text-[15px] text-gray-400">
      ...
      <section className="py-16 md:py-24 border-b border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-[22px] md:text-[28px] font-bold mb-4">Frequently Asked Questions</h2>
            <p className="text-[15px] text-gray-400">
