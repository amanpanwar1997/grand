...
export function DisplayAdsPage() {
  const breadcrumbItems = [
    ...
    { name: 'Display Ads', path: '/services/ppc/display-ads' }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-16 md:py-24 border-b border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-[22px] md:text-[28px] font-bold mb-4">Complete Display Advertising Services</h2>
      ...
      <section className="py-16 md:py-24 border-b border-white/5">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-[22px] md:text-[28px] font-bold mb-4">Why Choose Display Advertising?</h2>
            <p className="text-[15px] text-gray-400">
      ...
      <section className="py-16 md:py-24 border-b border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-[22px] md:text-[28px] font-bold mb-4">Our Display Ads Process</h2>
            <p className="text-[15px] text-gray-400">
      ...
      <section className="py-16 md:py-24 border-b border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-[22px] md:text-[28px] font-bold mb-4">Banner Sizes We Design</h2>
            <p className="text-[15px] text-gray-400">
