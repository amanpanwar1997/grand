...
import { Search, Calendar, Clock, ArrowRight, TrendingUp, Sparkles, Target, BarChart3, Globe, Award, Play, Mail, Building2, Shield, Filter, X, Grid3x3, Flame, Star, FolderOpen, Gauge } from 'lucide-react';
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <section className="py-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-6xl mx-auto">
                <p className="text-xs font-medium uppercase tracking-wide text-yellow-500 mb-6 text-center">ALL ARTICLES</p>
                <h2 className="mb-4 text-center leading-[1.3]">Browse All {filteredTopics.length} Articles</h2>
        ...
        <TabsContent value="featured" className="mt-0">
          <section className="py-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-6xl mx-auto">
                <p className="text-xs font-medium uppercase tracking-wide text-yellow-500 mb-6 text-center">FEATURED</p>
                <h2 className="mb-4 text-center leading-[1.3]">Top Featured Articles</h2>
                <p className="text-[0.9375rem] leading-relaxed text-gray-300 mb-12 text-center">
        ...
        <TabsContent value="trending" className="mt-0">
          <section className="py-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-6xl mx-auto">
                <p className="text-xs font-medium uppercase tracking-wide text-yellow-500 mb-6 text-center">TRENDING</p>
                <h2 className="mb-4 text-center leading-[1.3]">Popular Right Now</h2>
                <p className="text-[0.9375rem] leading-relaxed text-gray-300 mb-12 text-center">
          ...
          <section className="py-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <p className="text-xs font-medium uppercase tracking-wide text-yellow-500 mb-6 text-center">BY CATEGORY</p>
                <h2 className="mb-4 text-center leading-[1.3]">Browse by Topic</h2>
                <p className="text-[0.9375rem] leading-relaxed text-gray-300 mb-12 text-center">
        ...
        <TabsContent value="difficulty" className="mt-0">
          <section className="py-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto">
                <p className="text-xs font-medium uppercase tracking-wide text-yellow-500 mb-6 text-center">BY DIFFICULTY</p>
                <h2 className="mb-4 text-center leading-[1.3]">Browse by Skill Level</h2>
                <p className="text-[0.9375rem] leading-relaxed text-gray-300 mb-12 text-center">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="mb-6 leading-[1.3]">Get Weekly Marketing Insights</h2>
