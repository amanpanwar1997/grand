  ...
  return (
    <div>
        ...
        <div className="max-w-5xl mx-auto text-center md:text-left md:mr-auto md:ml-0 relative z-10">
          ...
          <AnimatedSection animation="fadeInUp" delay={0.2}>
            <h1 className="text-2xl md:text-3xl font-medium tracking-tight mb-8 leading-[1.3]">
              We are <span className="text-yellow-500">INCHTOMILEZ</span>
            </h1>
          </AnimatedSection>
      ...
      <section className="md:min-h-[100vh] py-16 md:py-24 flex items-center relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <p className="text-xs font-medium uppercase tracking-wide text-yellow-500 mb-6 text-center">WHO WE ARE</p>
      ...
      <section className="py-16 md:py-24 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto relative z-10">
            <p className="text-xs font-medium uppercase tracking-wide text-yellow-500 mb-6 text-center">OUR JOURNEY</p>
      ...
      <section className="py-16 md:py-24 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto relative z-10">
            <p className="text-xs font-medium uppercase tracking-wide text-yellow-500 mb-6 text-center">OUR TEAM</p>
            <h2 className="mb-4 text-center leading-[1.3]">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <p className="text-xs font-medium uppercase tracking-wide text-yellow-500 mb-6 text-center">WHY CHOOSE US</p>
            <h2 className="mb-16 text-center leading-[1.3]">
              Why Work With Us
            </h2>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <p className="text-xs font-medium uppercase tracking-wide text-yellow-500 mb-6 text-center">HOW WE WORK</p>
            <h2 className="mb-4 text-center leading-[1.3]">
              Our Process
            </h2>
            <p className="text-[0.9375rem] leading-relaxed text-gray-300 mb-16 text-center max-w-3xl mx-auto" style={{ lineHeight: 1.6 }}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="glass-strong p-8 md:p-12 rounded-2xl text-center">
              <h2 className="mb-4 leading-[1.3]">Get Marketing Insights</h2>
