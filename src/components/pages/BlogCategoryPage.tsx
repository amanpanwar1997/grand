...
import { Search, Calendar, Clock, ArrowRight, TrendingUp, Sparkles, Target, BarChart3, Globe, Award, Play, Mail, Building2, Shield, Filter, X, Grid3x3, Flame, Star, FolderOpen, Gauge, ChevronRight } from 'lucide-react';
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-6">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-[22px] font-bold">Featured Articles</h2>
            </div>
            <BentoGrid2 
              cards={featuredPosts}
              mode="asymmetric"
